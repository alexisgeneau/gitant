                ...
                <div className="w-full max-w-md">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="space-y-3">
                            <a
                                href="/auth/github"
                                className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-700 transition font-medium"
                            >
                            ...
                            <a
                                href="/auth/gitlab"
                                className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-500 transition font-medium"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
